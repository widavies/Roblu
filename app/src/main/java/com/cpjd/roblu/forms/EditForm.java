...
import com.cpjd.roblu.utils.EventSelectListener;
...
public class EditForm extends AppCompatActivity implements View.OnClickListener, EditListener, OnTabSelectListener, EventSelectListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.import_from_event) {
            if(!Text.launchEventPicker(this, this)) {
                Text.showSnackbar(findViewById(R.id.edit_form_layout), getApplicationContext(), "No events found.", true, 0);
            }
            return true;
        }
        return false;
