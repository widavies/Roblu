...
public class Tutorial extends AppCompatActivity implements SelectListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tuts.add(new RTutorial("Bluetooth", "Learn how to use setup Roblu's Bluetooth server for syncing events"));
        tuts.add(new RTutorial("Analytics", "Edit, organize, view, machine learning"));
        tuts.add(new RTutorial("MEGA-TUTORIAL", "Feeling ambitious? Learn about everything in one video."));
